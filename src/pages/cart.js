...
import {delAllPizzas} from "../redux/actions/cart";
import CartItem from "../components/CartItem";


const Cart = ({dispatch, cart}) => {
  const clearCart = () => {
    dispatch(delAllPizzas())
  }
  return (
    <div className="container container--cart">
      <div className="cart">
        ...
        <div className="content__items">
          {
            cart.toView.map((item, index) => {
              return <CartItem key={index} item={item} indexItem={item.currentIndex}/>
            })
          }
        ...
        <div className="cart__bottom">
          <div className="cart__bottom-details">
            <span> Всего пицц: <b>{cart.totalCount} шт.</b> </span>
